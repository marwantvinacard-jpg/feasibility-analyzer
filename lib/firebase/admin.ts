// Firebase Admin SDK (server-only). Powers the privileged operations the client
// is forbidden from doing by the security rules: creating analyses, granting
// credits, approving accounts, setting the admin custom claim. Credentials load
// from FIREBASE_SERVICE_ACCOUNT_JSON (prod) or the gitignored serviceAccountKey.json
