      ...
      <aside className="sticky top-0 hidden h-dvh flex-col border-r border-border bg-surface/40 p-4 md:flex">
        ...
        <nav className="mt-6 space-y-1">
          ...
          {user.role === "admin" && (
            <Link
              href="/admin"
              className="flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium text-muted transition hover:bg-surface-2 hover:text-ink"
            >
        ...
        <div className="mt-auto space-y-3">
          ...
          <div className="flex items-center justify-between gap-2 px-1">
            ...
            <button
              ...
              className="grid h-8 w-8 shrink-0 place-items-center rounded-lg text-faint transition hover:bg-surface-2 hover:text-stop"
              aria-label="Sign out"
            >
